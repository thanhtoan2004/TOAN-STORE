...
> **203+ API Routes** · **83 Database Tables** · **56 Unit Tests** · **100% Vietnamese JSDoc (Full Project)** · **Enterprise Grade (Level 3/3)** · **10/10 Security Score** · **v2.17.0 Stable ✅**
...
| [MySQL 8.0](https://www.mysql.com/)                              | Primary Database (83 tables)                            |
...
- **Membership & Loyalty**: Hệ thống cấp bậc thành viên (Bronze → Silver → Gold → Platinum) tự động tính chiết khấu và tích điểm. Thu hồi điểm khi hủy/hoàn trả và tự động hết hạn điểm định kỳ.
