async function start() {
    ...
    const adminId = 1;
    const productId = 1;
    const oldValues = { name: 'Old Product Name', retail_price: 100000 };
    const newValues = { name: 'New Product Name', retail_price: 93333 };
    ...
    if (logs.length > 0) {
        ...
        if (oldParsed.name === 'Old Product Name' && newParsed.retail_price === 93333) {
