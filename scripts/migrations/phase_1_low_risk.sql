...
-- Since they currently share IDs or are empty, we just need to update the FK constraint later.
ALTER TABLE `product_attribute_values` DROP FOREIGN KEY `product_attribute_values_ibfk_3`;
ALTER TABLE `product_attribute_values` ADD CONSTRAINT `product_attribute_values_ibfk_3` FOREIGN KEY (`option_id`) REFERENCES `attribute_values` (`id`) ON DELETE SET NULL;
