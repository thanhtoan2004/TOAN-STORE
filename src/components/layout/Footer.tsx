...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    promotions: [
      ...
      { name: 'First Responders & Medical', href: '/promo/first-responders-medical' },
    ...
    <footer className="bg-[#111] text-white pt-10">
      <div className="nike-container">
        ...
        <div className="flex space-x-4 py-5">
          ...
          <a href="https://www.facebook.com/thanhtoan6924" target="_blank" rel="noopener noreferrer" className="bg-gray-500 rounded-full p-2 hover:bg-white hover:text-gray-800 transition">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="py-6 border-t border-gray-700 flex flex-col md:flex-row justify-between text-gray-400 text-[10px]">
          ...
          <div className="flex flex-wrap gap-x-4 gap-y-2">
            ...
            <Link href="/ca-supply" className="hover:text-white">CA Supply Chain Act</Link>
          </div>
        </div>
      </div>
    </footer>
