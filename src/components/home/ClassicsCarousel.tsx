      ...
      .then(data => {
        if (data.success && data.products) {
          const formattedProducts = data.products.map((p: any) => ({
            id: p.id,
            name: p.name,
            imageUrl: p.image_url || 'data:image/svg+xml;base64,',
            link: `/products/${p.id}`
          }));
