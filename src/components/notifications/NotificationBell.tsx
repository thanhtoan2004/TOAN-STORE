...
import { Bell, X, Check, Trash2, ExternalLink, Package, MessageSquare, Tag, BellOff } from 'lucide-react';
...
export default function NotificationBell() {
    ...
    const getIcon = (type: string) => {
        switch (type) {
            ...
            case 'social': return <MessageSquare className="text-green-500" size={18} />;
            case 'promo': return <Tag className="text-red-500" size={18} />;
                    ...
                    >
                        <div className="p-4 border-b border-gray-50 flex items-center justify-between bg-white sticky top-0 z-10">
                            <div>
                                ...
                                <p className="text-[10px] text-gray-400 font-medium uppercase tracking-wider">Bạn có {unreadCount} thông báo mới</p>
                            </div>
                        ...
                        <div className="max-h-[400px] overflow-y-auto scrollbar-hide py-2 bg-gray-50/30">
                            {notifications.length > 0 ? (
                                notifications.map((notification) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0 pr-6">
                                            <h4 className={`text-sm font-bold truncate ${notification.is_read ? 'text-gray-600' : 'text-gray-900'}`}>
                                                {notification.title}
                                            </h4>
                                            <p className={`text-xs mt-1 line-clamp-2 leading-relaxed ${notification.is_read ? 'text-gray-400' : 'text-gray-600'}`}>
                                ...
                                <div className="py-12 flex flex-col items-center justify-center text-center px-6">
                                    ...
                                    <p className="text-xs text-gray-500 mt-1">Chúng tôi sẽ báo cho bạn khi có tin mới!</p>
                                </div>
                            )}
                        </div>
