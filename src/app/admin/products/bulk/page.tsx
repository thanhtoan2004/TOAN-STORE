                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                        ...
                        >
                            ...
                            {file ? (
                                <p className="text-sm font-medium text-gray-900">{file.name} ({(file.size / 1024).toFixed(1)} KB)</p>
                            ) : (
                                <>
                        ...
                        <button
                            ...
                            className={`mt-4 w-full py-2.5 rounded-lg text-sm font-semibold transition-all ${file && !uploading
                        ...
                        <div className="mt-4 p-3 bg-gray-50 rounded-lg text-xs text-gray-500">
                            ...
                            <code className="text-xs">name, base_price</code>
                            <p className="font-medium text-gray-700 mt-2 mb-1">Cột tùy chọn:</p>
                            <code className="text-xs">sku, slug, retail_price, short_description, description, category_name, brand_name, is_active, is_featured, is_new_arrival</code>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                        ...
                        <p className="text-sm text-gray-600 mb-6">
                            Xuất toàn bộ danh sách sản phẩm ra file Excel. File này có thể dùng để chỉnh sửa và import lại.
                        </p>
                        <button
