        ...
        return (
            <AdminLayout>
                <div className="p-8 text-center">
                    ...
                    <Link href="/admin/refunds" className="text-blue-600 hover:underline mt-4 inline-block">Quay lại</Link>
                </div>
            </AdminLayout>
        );
    }
        ...
        <AdminLayout>
            <div className="max-w-4xl mx-auto p-6">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <Link href="/admin/refunds" className="text-sm text-gray-500 hover:text-gray-700 mb-2 inline-block">← Quay lại danh sách</Link>
                        <h1 className="text-3xl font-bold text-gray-900">Chi tiết Yêu cầu #{refund.id}</h1>
                    </div>
                    <div className="flex items-center space-x-2">
                        <span className={`px-3 py-1 rounded-full text-sm font-medium ${refund.status === 'approved' ? 'bg-green-100 text-green-800' :
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <Link href={`/admin/orders/${refund.order_id}`} className="block text-blue-600 hover:underline font-medium">
                                    #{refund.order_number}
                                </Link>
                            ...
                            <hr />
                            <div>
                                <label className="text-xs text-gray-500 uppercase font-semibold">Số tiền hoàn</label>
