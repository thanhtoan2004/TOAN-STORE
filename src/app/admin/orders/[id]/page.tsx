    ...
    try {
      ...
      if (data.success) {
        ...
        data.data.items.forEach((item: OrderItem) => {
          const shippedQty =
            data.data.shipments?.reduce((sum: number, s: Shipment) => {
        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <div className="mt-2 flex items-center space-x-3">
              <span
                className={`px-2.5 py-0.5 rounded-full text-sm font-medium ${getStatusColor(order.status)}`}
              >
                  ...
                  >
                    <div className="px-6 py-4 bg-gray-50 flex justify-between items-center">
                      <div className="flex items-center space-x-4">
                        ...
                        <span className="text-xs px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded uppercase font-bold">
                          {shipment.carrier}
                        </span>
                      </div>
