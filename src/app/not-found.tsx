      ...
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            {(t as any).not_found?.desc ||
              'Có vẻ như đôi giày này đã được bán sạch hoặc đường dẫn này không còn tồn tại nữa.'}
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
          ...
          >
            ...
            <ArrowRight
              className="absolute right-4 opacity-0 transition-all group-hover:opacity-100 group-hover:translate-x-1"
              size={20}
            />
          </Link>
