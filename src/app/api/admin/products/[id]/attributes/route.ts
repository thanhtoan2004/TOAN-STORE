...
import { getProductAttributes, upsertProductAttribute, deleteProductAttribute } from '@/lib/db/repositories/attribute';
...
export async function POST(
    ...
    try {
        const { attribute_id, value_text, option_id } = await request.json();
