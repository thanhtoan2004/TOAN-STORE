        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="bg-white border-b sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-4 py-4 md:py-6 flex items-center gap-4">
                    <Link href="/account/settings" className="p-2 hover:bg-gray-100 rounded-full transition-colors">
            ...
            <div className="max-w-4xl mx-auto px-4 mt-8">
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-sm px-6">
                        ...
                        <h2 className="text-xl font-helvetica-medium text-gray-900 mb-2">Bạn chưa có voucher nào</h2>
                        <p className="text-gray-500 max-w-sm mx-auto mb-8">
                            Mã giảm giá cá nhân sẽ xuất hiện ở đây sau khi bạn nhận được từ các chương trình ưu đãi hoặc quà tặng.
                        </p>
                        <Link
                            href="/"
                            className="inline-block px-10 py-4 bg-black text-white rounded-full font-helvetica-medium hover:bg-gray-800 transition-colors"
                        >
                            ...
                            >
                                ...
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="bg-black text-white p-8 md:w-56 flex flex-col items-center justify-center text-center">
                                        <div className="text-sm font-helvetica-medium opacity-70 mb-1 uppercase tracking-widest text-white/80">GIẢM</div>
                                    ...
                                    <div className="flex-1 p-6 md:p-8 flex flex-col justify-between">
                                        <div>
                                            <div className="flex justify-between items-start mb-2">
                                                <h3 className="text-xl font-helvetica-bold text-gray-900">{voucher.description || 'Quà tặng dành cho bạn'}</h3>
                                                <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide ${voucher.status === 'active' ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-500'
                                                    }`}>
                                        ...
                                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mt-auto">
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center gap-2 text-sm text-gray-600">
                                                    ...
                                                    <span>Hạn dùng: {voucher.valid_until ? formatDate(voucher.valid_until) : 'Không giới hạn'}</span>
                                                </div>
                                            ...
                                            <div className="flex gap-2">
                                                <div
                                                    className={`flex items-center gap-3 px-4 py-2 border-2 ${copySuccess === voucher.code ? 'border-green-500 bg-green-50' : 'border-gray-200 bg-gray-50'
                                                ...
                                                >
                                                    ...
                                                    <Copy className={`w-5 h-5 ${copySuccess === voucher.code ? 'text-green-600' : 'text-gray-400'}`} />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="mt-12 p-8 bg-blue-50/50 rounded-3xl border border-blue-100/50 text-center">
                    ...
                    <p className="text-blue-700 text-sm mb-4">
                        Nếu bạn gặp khó khăn khi sử dụng mã, vui lòng liên hệ bộ phận hỗ trợ khách hàng của chúng tôi.
                    </p>
                    <Link href="/help" className="text-blue-600 font-helvetica-medium border-b border-blue-600 pb-0.5 hover:text-blue-800 transition-colors">
